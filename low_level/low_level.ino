...
unsigned int pedestrianReduceGreenTime1 = 3000; //Reduce the green time when pedestrian is crossing
...
unsigned int pedestrianReduceGreenTime2 = 5000; //Reduce the green time when pedestrian is crossing
